def greedy_greedy(actions,agent_actions):
    agent_1_actions=[]
    agent_2_actions=[]
    agent_3_actions=[]
...
actions,agent_actions=hazirlik_greedy(actions,factors,factor_actions)

start=datetime.datetime.now()
e1,c1=greedy_greedy(actions,agent_actions)
end=datetime.datetime.now()
plt.plot(e.index,e.utility_1)
plt.plot(e.index,e.utility_2)
plt.plot(e.index,e.utility_3)
plt.legend()
plt.show()
e.to_csv('actions_sonuc1.csv',index=False)
